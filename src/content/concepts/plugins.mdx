...
It is recommended that the first parameter of the tap method of the compiler hook should be a camelCase version of the plugin name. It is advisable to use a constant for this so it can be reused in all hooks.
